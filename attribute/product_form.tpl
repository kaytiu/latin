      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-attribute-new" data-toggle="tab">New-<?php echo $tab_attribute; ?></a></li>
            ...
            <li><a href="#tab-presale" data-toggle="tab"><?php echo $tab_presale; ?></a></li>
          </ul>
          <div class="tab-content">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
                  	<div style="position: absolute;width: 80px;right: 50px;top: 40px;"><button class="btn btn-primary" id="categoryApply" type="button">应用</button></div>                  
                  <!-- // modify by kwan OC-259（产品分类设置默认分类） -->
                    <?php foreach ($product_categories as $product_category) { ?>
                    <div id="product-category<?php echo $product_category['category_id']; ?>"><input 
                    type="radio" name="defaul_category_id" value="<?php echo $product_category['category_id']?>" 
                    class="category_radio"  <?php if($product_category['is_defaul'] == 1):?>checked="checked"<?php endif;?> /><span 
                    class="category_is_defaul"><i 
                    class="fa <?php if($product_category['is_defaul'] == 1):?>fa-check-circle<?php else:?>fa-circle<?php endif;?>"></i></span><i 
                    class="fa fa-trash"></i> <?php echo $product_category['name']; ?><input 
                    type="hidden" name="product_category[]" value="<?php echo $product_category['category_id']; ?>" /></div>
                    <?php } ?>
                  </div>
                  <?php if ($error_defaul_category_id) { ?>
                  <div class="text-danger"><?php echo $error_defaul_category_id; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
            ...
            <!-- 新的属性编辑标签  -->
            <div class="tab-pane" id="tab-attribute-new" ></div>
            <script type="text/javascript">
            	//商品主分类应用按钮点击事件 
            	$(document).ready(function(){
            		var prevDefCategoryId = $('[name="defaul_category_id"]:checked').val();
                	$('#categoryApply').bind('click',function(){
                    	console.log('categoryApply click....');
                		var defCategoryId = $('[name="defaul_category_id"]:checked').val();
                		if(prevDefCategoryId != defCategoryId){
                			prevDefCategoryId = defCategoryId;
                			getProductAttrGroup();
                		}
                    });
                    var getProductAttrGroup = function(){
                    	$.get('index.php?route=catalog/product/product_attr_group&token=<?php echo $token; ?>&product_id=<?php echo $this->request->get['product_id']?>&def_category_id=' + $('[name="defaul_category_id"]:checked').val(),function(data){
                			$('#tab-attribute-new').html(data);
                		});
                    };
                    getProductAttrGroup();
                });
                        ...
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
                              ...
                              <td class="text-right"><?php echo $entry_presale_quantity; ?></td>
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left">
                                <a href="" id="thumb-option-image-<?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_option_value['thumb'] ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />
                                  <input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][image]" value="<?php echo $product_option_value['image']?>" id="input-option-image-<?php echo $option_value_row; ?>" />
                              </td>
                              ...
                              <td class="text-right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][presale_quantity]" value="<?php echo $product_option_value['presale_quantity']; ?>" placeholder="<?php echo $entry_presale_quantity; ?>" class="form-control" /></td>
                ...
                <table id="discount" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="discount-row<?php echo $discount_row; ?>">
                      ...
                      <td class="text-right"><input type="text" name="product_discount[<?php echo $discount_row; ?>][presale_quantity]" value="<?php echo $product_discount['presale_quantity']; ?>" placeholder="<?php echo $entry_presale_quantity; ?>" class="form-control" /></td>
            ...
            <div class="tab-pane" id="tab-special">
              ...
              <?php if ($error_special_price) { ?>
            	<div class="text-danger"><?php echo $error_special_price; ?></div>
              <?php } ?>
            </div>
            <div class="tab-pane" id="tab-image">
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center"><?php echo $entry_main_image; ?></td>
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                   	  <td class="text-center">
                      	<?php if ($product_image['is_main']) { ?>
                      		<input type="radio" name="mainImage" value="<?php echo $image_row; ?>" checked="checked"/>
                      	<?php } else {?>
                      	<input type="radio" name="mainImage" value="<?php echo $image_row; ?>" />
                      	<?php } ?>
                      </td>
                      <td class="text-center"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
            ...
            <div class="tab-pane" id="tab-presale">                
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-presale-quantity"><?php echo $entry_presale_quantity; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="presale_quantity" value="<?php echo $presale_quantity; ?>" placeholder="<?php echo $entry_presale_quantity; ?>" id="input-presale-quantity" class="form-control" />
                </div>
              </div>
              
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-type"><?php echo $entry_presale_type; ?></label>
                <div class="col-sm-10">
                  <select name="presale_type" id="input-presale-type" class="form-control">
                    <?php if ($presale_type == 'P') { ?>
                    <option value="P" selected="selected"><?php echo $text_percent; ?></option>
                    <?php } else { ?>
                    <option value="P"><?php echo $text_percent; ?></option>
                    <?php } ?>
                    <?php if ($presale_type == 'F') { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-discount"><?php echo $entry_presale_discount; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="presale_discount" value="<?php echo $presale_discount; ?>" placeholder="<?php echo $entry_presale_discount; ?>" id="input-presale-discount" class="form-control" />
                </div>
              </div>
              
              <div class="form-group">
              	<label class="col-sm-2 control-label" for="input-date-end"><?php echo $entry_presale_date_end; ?></label>
                <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" name="presale_date_end" value="<?php echo $presale_date_end; ?>" placeholder="<?php echo $entry_presale_date_end; ?>" data-date-format="YYYY-MM-DD HH:mm:ss" id="input-presale-date-end" class="form-control" />
                    <span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-date-end"><?php echo $entry_arrival_date; ?></label>
                <div class="col-sm-3">
                  <input type="text" name="arrival_date" value="<?php echo $arrival_date; ?>" placeholder="<?php echo $entry_arrival_date; ?>" id="input-presale-date" class="form-control" />
                </div>
              </div>
              
              <div class="form-group">
				<label class="col-sm-2 control-label" for="input-presale-description"><?php echo $entry_presale_description; ?></label>
                <div class="col-sm-3">
                	<textarea name="presale_description" rows="5" placeholder="<?php echo $entry_presale_description; ?>" id="input-presale-description" class="form-control"><?php echo $presale_description; ?></textarea>
				</div>
			  </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_status; ?></label>
                <div class="col-sm-3">
                  <select name="presale_status" id="input-status" class="form-control">
                    <?php if ($presale_status) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
...
$('input[name=\'category\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-category').append('<div id="product-category' + item['value'] + '"><input type="radio" name="defaul_category_id" value="'+item['value']+'" class="category_radio" /><span class="category_is_defaul"><i class="fa fa-circle"></i></span><i class="fa fa-trash"></i> ' + item['label'] + '<input type="hidden" name="product_category[]" value="' + item['value'] + '" /></div>');
	}
});

$('#product-category').delegate('.fa-trash', 'click', function() {
	$(this).parent().remove();
});

$('#product-category').delegate('.category_radio', 'change', function() {
	$('.category_is_defaul >i').attr('class','fa fa-circle');
	$(this).parent().find('.category_is_defaul >i').removeClass('fa-circle');
	$(this).parent().find('.category_is_defaul >i').addClass('fa-check-circle');
});
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-right"><?php echo $entry_presale_quantity; ?></td>';
...
function addOptionValue(option_row) {	
    ...
    html += '  <td class="text-left"><a href="" id="thumb-option-image-' + option_value_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][image]" value="" id="input-option-image-' + option_value_row + '" /></td>';
	...
	html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][presale_quantity]" value="" placeholder="<?php echo $entry_presale_quantity; ?>" class="form-control" /></td>'; 
...
function addImage() {
	...
	html += '  <td class="text-center"><input type="radio" name="mainImage" value="'+image_row+'" /></td>';
	html += '  <td class="text-center"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
